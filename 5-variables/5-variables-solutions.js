...
// function guessMyNumber(n) {
//   var upperBound = 5
//   var correctNum = randInt(upperBound)
//   if (n > upperBound) {
//     return "Out of bounds! Please try a number between 0 and 5.";
//   } else if (n === correctNum) {
//     return "You guessed my number!";
//   }
//   return "Nope! The correct number was: " + correctNum;
// }
...
//     }
//     return "You guessed my number in " + guessCount + " guesses!";
//   }
...
// var guessCount = 0;
// var guessLimit = 5;
// var highScore = guessLimit;

// function resetGame() {
//   correctNum = randInt(upperBound);
//   guessCount = 0;
// }

// function guessMyNumber(n) {
//   var firstTryWin = "Congratulations! You guessed my number on the first try!"
//   var notFirstTryWin = "You guessed my number in " + guessCount + " guesses!"
//   var newHighScoreWin = " You also got a new high score!!"
...
//       newHighScore = true;
//       if (guessCount === 1) {
//         return firstTryWin  + newHighScoreWin;
//       } else {
//         return notFirstTryWin  + newHighScoreWin;
//       }
//     } else if (guessCount === 1) {
//       return firstTryWin
//     } else {
//       return notFirstTryWin;
//     }
//   }
//   return "Nope! Try again!";
// }
